...
async def create_phase(project_id: int, body: PhaseCreate, service: WBSServiceDep, current_user: CurrentUser):
...
async def update_phase(phase_id: int, body: PhaseUpdate, service: WBSServiceDep, current_user: CurrentUser):
...
async def get_wbs(project_id: int, service: WBSServiceDep, current_user: CurrentUser):
    return await service.tree(project_id, current_user)
