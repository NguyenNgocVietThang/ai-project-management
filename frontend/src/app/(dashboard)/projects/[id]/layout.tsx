...
import { ArrowLeft, BarChart3, GanttChartSquare, ListTodo, Network, Settings, Users } from 'lucide-react'
...
export default function ProjectLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [{ href: `/projects/${id}/overview`, label: 'Overview', icon: BarChart3 }, { href: `/projects/${id}/wbs`, label: 'Work Breakdown', icon: Network }, { href: `/projects/${id}/tasks`, label: 'Tasks', icon: ListTodo }, { href: `/projects/${id}/members`, label: 'Members', icon: Users }, { href: `/projects/${id}/settings`, label: 'Settings', icon: Settings }]
